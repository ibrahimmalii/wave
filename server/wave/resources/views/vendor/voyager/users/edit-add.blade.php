                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="+96687476763" value="{{ old('phone_number', $dataTypeContent->phone_number ?? '') }}" autocomplete="phone number">
                        </div>
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="isVerified" name="isVerified" value="1" autocomplete="Is Verified">
                        </div>
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="email" name="email" value="No Email Found" autocomplete="no email">
                        </div>
                        <div class="form-group">
